...
int main() {
	...
	RenderWindow window(VideoMode(1000, 600), "Flappy Bird Created By Taha");
	...
	game.scoreText.setFillColor(Color::Red);
	game.scoreText.setCharacterSize(40);
	game.scoreText.move(20, 0);
	game.highscoreText.setFont(game.font);
	game.highscoreText.setFillColor(Color::Red);
	game.highscoreText.move(800, 0);
